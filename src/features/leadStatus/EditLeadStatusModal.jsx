...
const EditLeadStatusModal = ({ isOpen = false, onClose = () => {}, leadStatus }) => {
  ...
  const form = useForm({ initialValues: { title: leadStatus.title, className: leadStatus.className } });
  ...
  return (
    <Modal centered title={"update lead status"} tt={"capitalize"} opened={isOpen} onClose={onClose}>
      <form onSubmit={form.onSubmit(handleSubmit)}>
        <Stack>
          ...
          <Switch label="default lead status" description="any other default will be replace with this" />
